...
public class Test_interpolate {
    ...
    public static void main(String[] args) throws IOException{
		...
		String pyPath = "/Users/kishoresubramanian/Sattva_Aravind/PythonCode/sattva-02-18-13-50-14";
    	String pyFilepath ="/Users/kishoresubramanian/Sattva_Aravind/PythonCode/FileChanger_2_Algo.py";
    	...
    	//String line2 = System.getenv(line);
            ...
            try {
                ...
                for (int i = 0; i < mInput.length; i++) {
                    ...
                    sb.append(",");sb.append(mInput[i][3]);
                    sb.append("\n");
                }
