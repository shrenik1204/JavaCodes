    ...
    private void doTask(int[] aQrsIndexArrF, int[] aQrsIndexArrI, double[][] aInputPCA, int[] aQrsM, int channel) {
        try{
            ...
            for (int i = 0; i < mNoQrs; i++) {
                ...
                try {
                    BufferedWriter br = new BufferedWriter(new FileWriter("aWeightWindowFunction.txt"));
                    StringBuilder sb = new StringBuilder();
//                    for (int i = 0; i < aPcaExtract.length; i++) {
                    for (int j = 0; j < aWeightWindowFunction.length; j++) {
                        sb.append(aWeightWindowFunction[j][0]);
                        sb.append("\n");
                    }
...
//			sb.append("\n");
            ...
            try {
                BufferedWriter br = new BufferedWriter(new FileWriter("aPcaExtract.txt"));
                StringBuilder sb = new StringBuilder();
                for (int i = 0; i < aPcaExtract.length; i++) {
                    for (int j = 0; j < aPcaExtract[0].length; j++) {
                        sb.append(aPcaExtract[i][j]);
                        sb.append(",");
                    }
